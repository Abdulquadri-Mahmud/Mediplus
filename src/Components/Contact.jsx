  ...
  return (
    <Box maxW={{'2xl': '70%', md: '80%'}} mx={'auto'} p={{md: 0, base: 5}} pb={'10vh'}>
       <Flex justifyContent={'center'} alignItems={'center'} flexDir={'column'} gap={3} mt={10}>
            <Heading textAlign={'center'} fontWeight={500} fontSize={{md: 35, base: 25}}>We Are Always Ready To Help You. <br /> Book An Appointment</Heading>
        ...
        <Flex justifyContent={'center'} alignItems={'center'} flexWrap={'wrap'} gap={6} mt={'10'}>
            <Box width={{md:'45%', base: '100%'}}>
                <form>
                    ...
                    <Flex justifyContent={'space-between'} alignItems={'center'} mt={5}>
                        <Button py={'25px'} bg={'blue.500'} color={'white'} rounded={3}>Book An Appointment</Button>
            ...
            <Box width={'100%'} px={{md: 20, base: 3}} py={{md: 20, base: 10}} bg={'gray.200'} mt={16}>
                <Flex justifyContent={'center'} alignItems={'center'} maxW={{'2xl': '90%'}} gap={10} color={'black'} mx={'auto'} flexWrap={'wrap'}>
                    <Box width={{md: '45%', base: '100%'}}>
                        <Heading fontSize={25} fontWeight={500} textAlign={{md: 'start', base: 'center'}}>Sign up for newsletter</Heading>
                        <Text mt={4} fontWeight={500} textAlign={{md: 'start', base: 'center'}}>Cu qui soleat partiendo urbanitas. Eum aperiri indoctum eu,homero alterum.</Text>
                    </Box>
                    <Flex justifyContent={'center'}>
                        <form className='md:w-[47%] w-[100%]'>
                            ...
                            <button className='uppercase p-4 md:w-[35%] w-[120px] text-blue-500 font-medium bg-slate-200'>Subscribe</button>
                        </form>
                    </Flex>
                </Flex>
            </Box>
