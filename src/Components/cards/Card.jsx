...
export default function Card() {
  return (
    <Flex alignItems={'center'} gap={7} flexWrap={'wrap'}  mx={{md: 'auto', base: 5}} maxW={{md: '80%', base: '100%'}}>
        <Box p={7} width={{md: '30%', base: '100%'}} rounded={6} bg={'blue.500'} height={{'2xl':'250px', xl: '100%'}} className='shadows '>
